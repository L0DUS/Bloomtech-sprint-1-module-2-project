...
console.log('number 1', Number(number1));
...
function multiply(a, b){
  ...
  console.log('multiple of values a and b', multiply(6, 5));
...
console.log('dog years', dogYears(18));
...
function hungryDog(dogAge, dogWeight){
  ...
  else if(dogAge < 0.583 && dogAge >= .333){
    return dogWeight * .05;
  }
  else if(dogAge < .333){
    return dogWeight * .1;
